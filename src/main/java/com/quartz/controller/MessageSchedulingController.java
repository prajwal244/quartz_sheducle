...
import com.quartz.config.QuartzConfig;
import com.quartz.dto.MessageDto;
import com.quartz.job.MessageJob;
import com.quartz.model.Message;
import com.quartz.repository.MessageRepository;
    ...
    public @ResponseBody  MessageDto scheduleMessageVisibility(@RequestBody  MessageDto messageDto) {
    	...
    	try {
            ...
            SimpleTrigger trigger = TriggerBuilder.newTrigger().withIdentity(id)
                    .startAt(triggerJobAt).withSchedule(SimpleScheduleBuilder.simpleSchedule().withIntervalInMinutes(messageDto.getMakeVisibleAt())
